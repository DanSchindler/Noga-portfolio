      ...
      {images && images.map((media, index) => (
        <React.Fragment key={index}>
          {index === headerIndex + 1 && project.process && (
            <Typography variant="h2" sx={{ marginTop: '130px', marginBottom: '50px', color: '#181818', fontFamily: 'Poppins', fontSize: '30px', fontWeight: '300', lineHeight: '149.805%', textAlign: 'center', '@media (max-width: 600px)': { marginTop: '70px', marginBottom: '0px', fontSize: '16px' } }}>
              Process
            </Typography>
          )}
